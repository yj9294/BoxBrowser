...
class UINativeAdView: GADNativeAdView {
    ...
    lazy var installLabel: UIButton = {
        ...
        label.setBackgroundImage(UIImage(named: "ad_button"), for: .normal)
        return label
    }()
}
...
extension UINativeAdView {
    ...
    func refreshUI(ad: GADNativeAd? = nil) {
        ...
        let bgColor = UIColor(red: 27 / 255.0, green: 32.0 / 255.0, blue: 67.0 / 255.0, alpha: 1.0)
        let subTitleColor = UIColor(red: 151 / 255.0, green: 158 / 255.0, blue: 167 / 255.0, alpha: 1.0)
